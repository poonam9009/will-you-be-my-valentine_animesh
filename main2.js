document.addEventListener("DOMContentLoaded", function () {
  ...
  function yes() {
    if (counter >= 3) {
        ...
        wedate.innerText = "We are each other's valentine now. yapapapa muuunhhh yapaaaapaaa muuunhhh yappppaaaa❤️😘";

        // Open index1.html in a new tab
        window.open("index1.html", "_blank");

    } else {
        alert("Don't say yes right away, darling. Play around a bit 😉😘");
    }
}
